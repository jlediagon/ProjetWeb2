...
class __TwigTemplate_e7e466bbca7608d135d69c1fafa0a917cb133133b5ffc6218ddd205b92e88730 extends Twig_Template
{
        ...
        <table class=\"decision-log\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["decision"]) {
                ...
                if ((twig_length_filter($this->env, $this->getAttribute($context["decision"], "attributes", array())) == 1)) {
                    ...
                    // line 321
                    echo "                                ";
                    if ($this->getAttribute((isset($context["attribute"]) ? $context["attribute"] : null), "expression", array(), "any", true, true)) {
                        // line 322
                        echo "                                    Expression: <pre><code>";
                        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["attribute"]) ? $context["attribute"] : $this->getContext($context, "attribute")), "expression", array()), "html", null, true);
                        echo "</code></pre>
                                ";
                    } elseif (($this->getAttribute(                    // line 323
(isset($context["attribute"]) ? $context["attribute"] : $this->getContext($context, "attribute")), "type", array()) == "string")) {
                        // line 324
                        echo "                                    ";
                        ...
                        // line 326
                        echo "                                     ";
                        echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), array($this->env, (isset($context["attribute"]) ? $context["attribute"] : $this->getContext($context, "attribute"))));
                        echo "
                                ";
                    }
                    // line 328
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/var/www/html/FormdGseb/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views/Collector/security.html.twig");
    }
}
