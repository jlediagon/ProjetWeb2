...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->methodMap = array(
            ...
            'doctrine.dbal.logger.profiling.demande' => 'getDoctrine_Dbal_Logger_Profiling_DemandeService',
        ...
        $this->fileMap = array(
            ...
            'doctrine.dbal.demande_connection' => 'getDoctrine_Dbal_DemandeConnectionService.php',
            ...
            'doctrine.orm.demande_entity_listener_resolver' => 'getDoctrine_Orm_DemandeEntityListenerResolverService.php',
            'doctrine.orm.demande_entity_manager' => 'getDoctrine_Orm_DemandeEntityManagerService.php',
            'doctrine.orm.demande_entity_manager.property_info_extractor' => 'getDoctrine_Orm_DemandeEntityManager_PropertyInfoExtractorService.php',
            'doctrine.orm.demande_listeners.attach_entity_listeners' => 'getDoctrine_Orm_DemandeListeners_AttachEntityListenersService.php',
            'doctrine.orm.demande_manager_configurator' => 'getDoctrine_Orm_DemandeManagerConfiguratorService.php',
            ...
            'doctrine_cache.providers.doctrine.orm.demande_metadata_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DemandeMetadataCacheService.php',
            'doctrine_cache.providers.doctrine.orm.demande_query_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DemandeQueryCacheService.php',
            'doctrine_cache.providers.doctrine.orm.demande_result_cache' => 'getDoctrineCache_Providers_Doctrine_Orm_DemandeResultCacheService.php',
        ...
        $this->privates = array(
            ...
            'doctrine.dbal.logger.profiling.demande' => true,
            ...
            'doctrine.orm.demande_entity_listener_resolver' => true,
            'doctrine.orm.demande_entity_manager.property_info_extractor' => true,
            'doctrine.orm.demande_listeners.attach_entity_listeners' => true,
            'doctrine.orm.demande_manager_configurator' => true,
        ...
        $this->aliases = array(
            ...
            'database_connection' => 'doctrine.dbal.demande_connection',
            'doctrine.orm.default_metadata_cache' => 'doctrine_cache.providers.doctrine.orm.default_metadata_cache',
            'doctrine.orm.default_query_cache' => 'doctrine_cache.providers.doctrine.orm.default_query_cache',
            'doctrine.orm.default_result_cache' => 'doctrine_cache.providers.doctrine.orm.default_result_cache',
            'doctrine.orm.demande_metadata_cache' => 'doctrine_cache.providers.doctrine.orm.demande_metadata_cache',
            'doctrine.orm.demande_query_cache' => 'doctrine_cache.providers.doctrine.orm.demande_query_cache',
            'doctrine.orm.demande_result_cache' => 'doctrine_cache.providers.doctrine.orm.demande_result_cache',
            'doctrine.orm.entity_manager' => 'doctrine.orm.demande_entity_manager',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('NYtQMRcBNn', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xB9YR7+kaV', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['doctrine'] = new \Doctrine\Bundle\DoctrineBundle\Registry($this, $this->parameters['doctrine.connections'], $this->parameters['doctrine.entity_managers'], 'demande', 'demande');
    }
    ...
    protected function getProfilerService()
    {
        ...
        $d->addLogger('demande', ${($_ = isset($this->services['doctrine.dbal.logger.profiling.demande']) ? $this->services['doctrine.dbal.logger.profiling.demande'] : $this->services['doctrine.dbal.logger.profiling.demande'] = new \Doctrine\DBAL\Logging\DebugStack()) && false ?: '_'});
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qN998fJIiL', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wa4d7wQBqT', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9VF8v8IkcK', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    /**
     * Gets the private 'doctrine.dbal.logger.profiling.demande' shared service.
     *
     * @return \Doctrine\DBAL\Logging\DebugStack
     */
    protected function getDoctrine_Dbal_Logger_Profiling_DemandeService()
    {
        return $this->services['doctrine.dbal.logger.profiling.demande'] = new \Doctrine\DBAL\Logging\DebugStack();
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('14762beb6515dd450322093d1836b8c1d11932e4')) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/CoreBundle/Resources/views'), 'GSEBCore');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/CoreBundle/Resources/views'), '!GSEBCore');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/MainBundle/Resources/views'), 'GSEBMain');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/MainBundle/Resources/views'), '!GSEBMain');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/DemandeBundle/Resources/views'), 'GSEBDemande');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/DemandeBundle/Resources/views'), '!GSEBDemande');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/ValidBundle/Resources/views'), 'GSEBValid');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/ValidBundle/Resources/views'), '!GSEBValid');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/AdminHistoryBundle/Resources/views'), 'GSEBAdminHistory');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/AdminHistoryBundle/Resources/views'), '!GSEBAdminHistory');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/UserHistoryBundle/Resources/views'), 'GSEBUserHistory');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/UserHistoryBundle/Resources/views'), '!GSEBUserHistory');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/UserBundle/Resources/views'), 'GSEBUser');
        $instance->addPath(($this->targetDirs[3].'/src/GSEB/UserBundle/Resources/views'), '!GSEBUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('14762beb6515dd450322093d1836b8c1d11932e4');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'GSEBCoreBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GSEB/CoreBundle'),
                    'namespace' => 'GSEB\\CoreBundle',
                ),
                'GSEBMainBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GSEB/MainBundle'),
                    'namespace' => 'GSEB\\MainBundle',
                ),
                'GSEBDemandeBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GSEB/DemandeBundle'),
                    'namespace' => 'GSEB\\DemandeBundle',
                ),
                'GSEBValidBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GSEB/ValidBundle'),
                    'namespace' => 'GSEB\\ValidBundle',
                ),
                'GSEBAdminHistoryBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GSEB/AdminHistoryBundle'),
                    'namespace' => 'GSEB\\AdminHistoryBundle',
                ),
                'GSEBUserHistoryBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GSEB/UserHistoryBundle'),
                    'namespace' => 'GSEB\\UserHistoryBundle',
                ),
                'GSEBUserBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/GSEB/UserBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'GSEBCoreBundle' => 'GSEB\\CoreBundle\\GSEBCoreBundle',
                'GSEBMainBundle' => 'GSEB\\MainBundle\\GSEBMainBundle',
                'GSEBDemandeBundle' => 'GSEB\\DemandeBundle\\GSEBDemandeBundle',
                'GSEBValidBundle' => 'GSEB\\ValidBundle\\GSEBValidBundle',
                'GSEBAdminHistoryBundle' => 'GSEB\\AdminHistoryBundle\\GSEBAdminHistoryBundle',
                'GSEBUserHistoryBundle' => 'GSEB\\UserHistoryBundle\\GSEBUserHistoryBundle',
                'GSEBUserBundle' => 'GSEB\\UserBundle\\GSEBUserBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'racktables',
            'database_user' => 'root',
            'database_password' => 'Bonjour1997',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '14762beb6515dd450322093d1836b8c1d11932e4',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => '14762beb6515dd450322093d1836b8c1d11932e4',
            ...
            'doctrine.entity_managers' => array(
                ...
                'demande' => 'doctrine.orm.demande_entity_manager',
            ),
            'doctrine.default_entity_manager' => 'demande',
            'doctrine.dbal.connection_factory.types' => array(

            ),
            'doctrine.connections' => array(
                'default' => 'doctrine.dbal.default_connection',
                'demande' => 'doctrine.dbal.demande_connection',
            ),
            'doctrine.default_connection' => 'demande',
