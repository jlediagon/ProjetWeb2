 ...
 */
class Attribut extends \GSEB\MainBundle\Entity\Attribut implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GSEB\\MainBundle\\Entity\\Attribut' . "\0" . 'object', '' . "\0" . 'GSEB\\MainBundle\\Entity\\Attribut' . "\0" . 'id', '' . "\0" . 'GSEB\\MainBundle\\Entity\\Attribut' . "\0" . 'value', '' . "\0" . 'GSEB\\MainBundle\\Entity\\Attribut' . "\0" . 'attrId'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Attribut $proxy) {
    ...
    public function setAttrId($attrId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAttrId', [$attrId]);

        return parent::setAttrId($attrId);
    }
